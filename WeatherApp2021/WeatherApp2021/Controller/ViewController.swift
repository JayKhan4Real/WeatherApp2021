...
class ViewController: UIViewController, CLLocationManagerDelegate {
    ...
    // label for the current date and time
   ...
   let currentDate: UILabel = {
    ...
    // label for the current temp description and symbol
    ...
    // label for the max and min temp 
    ...
    // code for the city's current weather

     func loadData(city: String) {
            networkManager.fetchCurrentWeather(city: city) { (weather) in
                 print("Current Temperature", weather.main.temp.kelvinToFahrenheitConverter())
                 let dateFormatter = DateFormatter();
                 dateFormatter.dateFormat = "dd MMM yyyy hh:mm a"
                 let date = dateFormatter.string(from: Date())
                 
                 DispatchQueue.main.async {
                     self.currentTemperatureLabel.text = (String(weather.main.temp.kelvinToFahrenheitConverter()) + "°F")
                     ...
                     self.minTemp.text = ("Min: " + String(weather.main.temp_min.kelvinToFahrenheitConverter()) + "°F" )
                     self.maxTemp.text = ("Max: " + String(weather.main.temp_max.kelvinToFahrenheitConverter()) + "°F" )
...
// view setups
    ...
    // layout placement of the labels
    ...
    func layoutViews() {
        ...
        currentDate.heightAnchor.constraint(equalToConstant: 10).isActive = true
    ...
    //   handlers and navigation buttons
